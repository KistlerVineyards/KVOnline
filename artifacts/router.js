    ...
    try {
        let data = {
            ...
            sqlParms: {
                ...
                ShipZip: req.body.ShippingZip,
                ShipCountry: req.body.ShipCountry,
                MailResidential: true,
                ShipResidential: req.body.UseMailing == "on" ? true : false,
                SendOrderBy: "email",
                //UseMailing: req.body.UseMailing,
                //ShipName: req.body.UseMailing ? req.body.MailName : req.body.ShipName,
                //ShipCo: req.body.UseMailing ? req.body.MailCo : req.body.ShipCo,
                //ShipStreet1: req.body.UseMailing ? req.body.MailStreet1 : req.body.ShipStreet1,
                //ShipStreet2: req.body.UseMailing ? req.body.MailStreet2 : req.body.ShipStreet2,
                //ShipCity: req.body.UseMailing ? req.body.MailCity : req.body.ShipCity,
                //ShipState: req.body.UseMailing ? req.body.MailState : req.body.ShipState,
                //ShipZip: req.body.UseMailing ? req.body.MailZip : req.body.ShippingZip,
                //ShipCountry: req.body.UseMailing ? req.body.MailCountry : req.body.ShipCountry,
