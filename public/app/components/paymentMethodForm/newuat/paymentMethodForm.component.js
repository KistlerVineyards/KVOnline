...
var PaymentMethodForm = (function () {
    ...
    PaymentMethodForm.prototype.initPayMethodForm = function () {
        ...
        this.payMethodForm = this.fb.group({
            ...
            state: ['', [forms_1.Validators.required, customValidators_1.CustomValidators.StateLengthValidator]],
...
__decorate([
    ...
    __metadata("design:type", Object)
], PaymentMethodForm.prototype, "profile", void 0);
PaymentMethodForm = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof app_service_1.AppService !== "undefined" && app_service_1.AppService) === "function" && _a || Object, forms_1.FormBuilder, api_1.ConfirmationService])
], PaymentMethodForm);
